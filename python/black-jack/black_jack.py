...
def value_of_card(card: str) -> int:
    ...
    return cards[card] if card in cards else int(card)
...
def higher_card(card_one: str, card_two: str) -> str | tuple[str]:
    ...
    return card_one if value_card_one > value_card_two else card_two
...
def value_of_ace(card_one: str, card_two: str) -> int:
    ...
    value_card_one = value_of_card(card_one)
    value_card_two = value_of_card(card_two)
    if value_card_one + value_card_two > 10 or "A" in [card_one, card_two]:
        return 1
    return 11
...
def can_split_pairs(card_one: str, card_two: str) -> bool:
    ...
    :return: bool - can the hand be split into two pairs? (i.e. cards
